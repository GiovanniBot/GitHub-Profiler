...
export function Header() {
  ...
  return (
    <div className=' sticky top-0 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 mb-4 border-b z-10'>
      <div className='flex items-center mx-auto py-3 sm:py-5 md:py-3 w-11/12'>
